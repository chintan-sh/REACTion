...
/***/ function(module, exports, __webpack_require__) {
	...
	* */
	...
	var Intro = __webpack_require__(159);
	...
	ReactDOM.render(React.createElement(Intro, { name: firstName, message: msg }), document.getElementById("app"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1); // residing inside node_modules (installed using npm)
	var IntroMessage = __webpack_require__(160);
	var IntroForm = __webpack_require__(161);
	...
	var Intro = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(IntroMessage, { name: name, message: message }),
	            React.createElement(IntroForm, { onNewName: this.handleNewName, onNewMessage: this.handleNewMessage })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IntroForm = React.createClass({
	    ...
	    onFormButtonClick: function onFormButtonClick(e) {
	        e.preventDefault();
	    ...
	    render: function render() {
	        return React.createElement(
	            'form',
	            { onSubmit: this.onFormButtonClick },
	            React.createElement(
	                'div',
	                null,
	                React.createElement(
	                ...
	                React.createElement('input', { type: 'text', name: 'firstNameBox', placeholder: 'Enter your first name', ref: 'firstName' })
	            ),
	            React.createElement(
	                'div',
	                null,
	                ...
	                React.createElement('textarea', { ref: 'userMessage', placeholder: 'Enter your message', name: 'messageBox' })
	            ),
	            React.createElement(
	                'div',
	                null,
